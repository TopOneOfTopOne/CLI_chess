module Chess
  ...
  class Board
    ...
    def init_place_piece
      (0..7).each {|pos| @grid[pos][1] = Pawn.new('pos', :white)}
      (0..7).each {|pos| @grid[pos][6] = Pawn.new('pos', :black)}
      @grid[0][0] = Rook.new('rook0', :white)
      @grid[7][0] = Rook.new('rook1', :white)
      @grid[0][7] = Rook.new('rook0', :black)
      @grid[7][7] = Rook.new('rook1', :black)
      @grid[1][0] = Knight.new('knight0', :white)
      @grid[6][0] = Knight.new('knight1', :white)
      @grid[1][7] = Knight.new('knight0', :black)
      @grid[6][7] = Knight.new('knight1', :black)
